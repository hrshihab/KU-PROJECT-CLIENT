...
//               <h1 className=" text-6xl lg:text-7xl font-bold text-white leading-tight mb-16">
//                 University for
//                 <br />
//                 Tomorrow
//               </h1>
...
//                 <div>
//                   <h2 className="text-xl md:text-3xl lg:text-4xl font-bold">Teachers</h2>
//                   <p className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2">200+</p>
//                 </div>
//                 <div>
//                   <h2 className="text-xl md:text-3xl lg:text-4xl font-bold">Students</h2>
//                   <p className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2">2M+</p>
//                 </div>
//                 <div>
//                   <h2 className="text-xl md:text-3xl lg:text-4xl font-bold">Research</h2>
//                   <p className="text-3xl md:text-4xl lg:text-5xl font-bold mt-2">1200+</p>
//                 </div>
//                 <div>
//                   <h2 className="text-xl md:text-3xl lg:text-4xl font-bold">Awards</h2>
